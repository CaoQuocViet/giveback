...
export function AdminProfile() {
  const [userData, setUserData] = useState<AdminProfileResponse["data"] | null>(
    null
  )
  ...
  const fetchProfile = async () => {
    try {
      ...
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/api/profile/admin`,
        {
          headers: {
          ...
          <div className="mb-8 flex items-center space-x-6">
            ...
            <div>
              <div className="flex items-center gap-3">
                ...
                <Badge
                  variant={
                    userData.admin.isSystemAdmin ? "default" : "secondary"
                  }
                >
                  {userData.admin.isSystemAdmin
                    ? "Quản trị hệ thống"
                    : "Quản trị viên"}
                </Badge>
              </div>
