  ...
  exportPDF: (campaign: any) => {
    const content = `
      <div style="font-family: Arial, sans-serif; color: black;">
        ...
        <p style="color: black;"><strong>Tổ chức:</strong> ${
          campaign.charity.name
        }</p>
        <p style="color: black;"><strong>Thời gian:</strong> ${new Date(
      ...
      campaign.timeline.end_date
        ...
        ${campaign.donations
          ...
          <div>
            ...
            <p style="color: black;"><strong>Người đóng góp:</strong> ${
              donation.donor.name
            }</p>
            <p style="color: black;"><strong>Số tiền:</strong> ${new Intl.NumberFormat(
              "vi-VN",
              {
                style: "currency",
                currency: "VND",
            ...
            <p style="color: black;"><strong>Phương thức:</strong> ${
              donation.payment_method
            }</p>
            <p style="color: black;"><strong>Trạng thái:</strong> ${
              donation.status
            }</p>
            <p style="color: black;"><strong>Thời gian:</strong> ${new Date(
              donation.created_at
            ).toLocaleDateString("vi-VN")}</p>
            <p style="color: black;"><strong>Ghi chú:</strong> ${
              donation.message || ""
            }</p>
            <hr />
          </div>
        ...
        ${campaign.distributions
          ...
          <div>
            ...
            <p style="color: black;"><strong>Mô tả:</strong> ${
              distribution.description
            }</p>
            <p style="color: black;"><strong>Ngày cứu trợ:</strong> ${new Date(
              distribution.relief_date
            ).toLocaleDateString("vi-VN")}</p>
            <p style="color: black;"><strong>Ngân sách:</strong> ${new Intl.NumberFormat(
              "vi-VN",
              {
                style: "currency",
                currency: "VND",
            ...
            <p style="color: black;"><strong>Số lượng người hưởng lợi:</strong> ${
              distribution.beneficiary_count
            }</p>
            <p style="color: black;"><strong>Địa chỉ:</strong> ${
              distribution.location.address
            }, ${distribution.location.ward}, ${
              distribution.location.district
            }, ${distribution.location.province}</p>
            <hr />
          </div>
        `
          )
