...
import { AuthorSetup, NavbarSetup, NavbarSetupType, NavbarSetup_NAVLINKS, NavbarSetup_Socials } from "@/components/news/constants/codeBlocks";
...
const BlogSetup = () => {
            ...
            <div className='container px-3 pb-[20px] md:mt-[50px] pt-20 md:pt-0'>
                ...
                <List type={ListType.disc} className="mt-5">
                    ...
                    <li className="">
                        ...
                        <a href="https://github.com/CaoQuocViet/giveback" className="pl-2 font-semibold" target="_blank" rel="noopener noreferrer">
                            https://github.com/CaoQuocViet/giveback
                        </a>
                        <br />
                        If you are using Git you can clone the code or click the <b>use template</b> button to generate your own repo.
                        <Image className="mt-3" src="/public/news_imp_assets/tutorials/download-code.png" alt="nextjs-simple-blog-template" size={ImageSize.DEFAULT} />
                    </li>
                    <li className="">
                    ...
                    <li className="mb-20">
                        ...
                        <Image className="my-4" src="/public/news_imp_assets/tutorials/project-install.png" alt="nextjs-simple-blog-template" size={ImageSize.DEFAULT} />

                        After the installation is done run <b>npm start</b> in the terminal, it will start your project on http://localhost:3000/.

                        <br />
                        If you are facing any difficulty, write a comment on our discussion board <b><i><a href="https://github.com/CaoQuocViet/giveback/discussions/6" target="_blank" rel="noopener noreferrer">LINK</a></i></b>
                ...
                <Text p >
                    Goto <b>_BLOG_SETUP.tsx</b> in <b>NEWS_CONSTANTS</b> folder. Here you will see some example authors you can refer. <br />
                ...
                <Text p >
                    Goto <b>_BLOG_SETUP.tsx</b> file in <b>NEWS_CONSTANTS</b> folder. Here you will see example to setup your navbar. <br />
    ...
    `
                    ...
                    <li>
                        ...
                        You can get the icons from <b><LinkTo href="/news/all-news/icons" passHref={true}>Icons</LinkTo></b>
