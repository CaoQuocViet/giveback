      ...
      <div className="prose max-w-none">
        ...
        <div className="bg-gray-50 p-4 rounded-lg mb-6">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>Bão Yagi - cơn bão mạnh nhất trong 30 năm tại Việt Nam với sức gió cấp 14, giật cấp 17</li>
            <li>Gây thiệt hại nặng nề tại Quảng Ninh, Hải Phòng và các tỉnh miền Bắc</li>
            <li>29 người thiệt mạng, 1.609 người bị thương trong ngày bão đổ bộ</li>
        ...
        />
        <div className="my-6">
          <h2 className="text-2xl font-semibold mb-4">Trực diện với bão</h2>
        ...
        <div className="my-6">
          <h2 className="text-2xl font-semibold mb-4">Diễn biến 15 giờ bão</h2>
          <div className="space-y-4">
            <div className="border-l-4 border-blue-500 pl-4">
              <p className="font-semibold">12:00 - Bão đổ bộ</p>
              <p>1,4 triệu người Quảng Ninh và 2 triệu dân Hải Phòng hứng chịu cơn bão với sức gió cấp 12-14</p>
            </div>
            <div className="border-l-4 border-blue-500 pl-4">
              <p className="font-semibold">19:00 - Bão vào Hà Nội</p>
              <p>4 người chết, 23 bị thương; trên 40.000 cây xanh gãy đổ; hơn 2.500 ngôi nhà bị hư hại</p>
            </div>
          </div>
        </div>
        <Image
        ...
        <blockquote className="border-l-4 border-gray-300 pl-4 my-6 italic">
          "24 năm làm khí tượng, tôi trải qua không ít cơn bão, nhưng lần đầu tiên rơi vào hoàn cảnh kinh hãi đến vậy"
          <footer className="text-gray-600 mt-2">- Trạm trưởng Vũ Thị Trường</footer>
        </blockquote>
