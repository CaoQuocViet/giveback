...
'use client';
import { PageLayout, Text, LinkTo, Seperator, Image } from "@/components/news/news-components";
import CodeBlock from "@/components/news/news-components/CodeBlock";
import { iSEO } from "@/components/news/shared/interfaces";
...
const Icons = () => {
    const PAGE_SEO: iSEO = {
        ...
        author: 'Nguyễn Đình Khánh, Cao Quốc Việt'
    }
    return (
        <PageLayout PAGE_SEO={PAGE_SEO} home>
            <div className="container pb-5 md:mt-[50px] pt-20 md:pt-0">
                ...
                <Image src="/public/news_imp_assets/tutorials/reacticons.png" alt="webexpe.com" caption="ReactIcons website screenshot" />
