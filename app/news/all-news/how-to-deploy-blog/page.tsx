...
'use client';
import { ImageSize, TextAlign, ListType } from "@/components/news/shared/enums";
import { PageLayout, Text, List, Image, LinkTo, Seperator, Slider } from "@/components/news/news-components";
            ...
            <div className='container px-3 pb-5 md:mt-[50px] pt-20 md:pt-0'>
                ...
                <List type={ListType.disc} className="mt-5">
                    <li>
                        ...
                        <Image className="mt-5" src="/public/news_imp_assets/tutorials/stop-server.png" alt="nextjs-simple-blog-template" size={ImageSize.DEFAULT} />
                    </li>
                    <li>
                        Run <b>npm run out</b><br />
                        In the terminal run <b>npm run out</b>.
                        <Image className="mt-5" src="/public/news_imp_assets/tutorials/npm-run-out.png" alt="nextjs-simple-blog-template" size={ImageSize.MEDIUM} />
                        <Image className="mt-5" src="/public/news_imp_assets/tutorials/export-done.png" alt="nextjs-simple-blog-template" size={ImageSize.MEDIUM} />
                    </li>
                    <li>
                        After the export is successful. You will see a new folder created named <b>out</b> in you project directory .
                        <Image className="my-5" src="/public/news_imp_assets/tutorials/out-folder.png" alt="nextjs-simple-blog-template" size={ImageSize.XS} />
                ...
                <List type={ListType.disc} className="mt-5">
                    ...
                    <li>
                        ...
                        <Image className="my-5" src="/public/news_imp_assets/tutorials/firebase-create-proj.png" alt="nextjs-simple-blog-template" size={ImageSize.DEFAULT} />
                    ...
                    <li>
                        ...
                        <Image className="my-5" src="/public/news_imp_assets/tutorials/select-hosting.png" alt="nextjs-simple-blog-template" size={ImageSize.SMALL} />
                        <Image className="my-5" src="/public/news_imp_assets/tutorials/hosting-gs.png" alt="nextjs-simple-blog-template" size={ImageSize.DEFAULT} />
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <Image className="my-5" src="/public/news_imp_assets/tutorials/use-exi.png" alt="nextjs-simple-blog-template" caption="Select Use an Existing Project" size={ImageSize.DEFAULT} />
                        ...
                        <Image className="my-5" src="/public/news_imp_assets/tutorials/select-proj.png" alt="nextjs-simple-blog-template" size={ImageSize.DEFAULT} />
                        ...
                        <List type={ListType.number} className="mt-5">
                            <li>
                                ...
                                <Image className="my-5" src="/public/news_imp_assets/tutorials/select-dir.png" alt="nextjs-simple-blog-template" size={ImageSize.DEFAULT} />
                            </li>
                            <li>
                        ...
                        <Image className="my-5" src="/public/news_imp_assets/tutorials/firebase-complete.png" alt="nextjs-simple-blog-template" caption="Firebase Setup Complete" size={ImageSize.DEFAULT} />

                        Finally run <b>firebase deploy</b> and your peoject will be deployed on your firebase hosting.
                        <Image className="my-5" src="/public/news_imp_assets/tutorials/fb-deploy.png" alt="nextjs-simple-blog-template" caption="Firebase Deploy" size={ImageSize.DEFAULT} />
                    </li>
                    <li>
                        <b>* note</b><br />
