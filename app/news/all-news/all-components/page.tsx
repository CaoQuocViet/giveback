...
import {
  ...
  Accordian,
  VideoPlayer,
} from "@/components/news/news-components";
import { ListType, ImageSize } from "@/components/news/shared/enums";
...
import {
  ...
  HowToUseAccordian,
  HowToUseVideo,
} from "@/components/news/constants/codeBlocks";
        ...
        <div className="flex md:flex-nowrap flex-wrap relative items-start mt-8">
          ...
          <aside className="md:w-1/5 w-full md:sticky md:top-[90px] ">
            <div className="md:rounded-lg md:p-3 md:block px-2 py-3 md:pb-0 bg-white dark:bg-slate-800 shadow-md mb-5 flex overflow-auto">
              {sideBtnsComponents()}
              <LinkTo
                href="/news/all-news/style-guide.tsx"
            ...
            <div className="md:rounded-lg md:p-3 bg-white dark:bg-slate-800 shadow-md overflow-auto md:text-xl text-md font-semibold whitespace-nowrap md:block hidden">
              <LinkTo href="/news/all-news/style-guide.tsx">
                Style Guide
              </LinkTo>
            </div>
          </aside>
          ...
          <aside className="md:w-4/5 w-full md:px-[15px]">
            <section className={cardBBorder} id="pageLayouts">
              ...
              <u>
                <LinkTo href="/news/all-news/home-layout.tsx">Home</LinkTo>
              </u>
              ,{" "}
              <u>
                <LinkTo href="/news/all-news/blog-with-sidebar-layout">
                  Blog with sidebar
                </LinkTo>
              </u>{" "}
              and{" "}
              <u>
                <LinkTo href="/news/all-news/blog-with-centered-layout">
                  Blog centered
                </LinkTo>
              </u>
              . <br />
            ...
            <section className={cardBBorder} id="image">
              ...
              image tag's src. For demo check <b>/pages/all-components</b>{" "}
              file in code. <br />
              <br />
              <b>Demo</b>
              <div className="flex flex-wrap">
                <Image
                  src="/public/news_imp_assets/tutorials/demo-image.jpg"
            ...
            <section className={cardBBorder} id="imageslider">
              ...
              <Slider
                className="mb-5"
                images={[
                  "/public/news_imp_assets/tutorials/demo-image.jpg",
                  "/public/news_imp_assets/tutorials/demo-image.jpg",
                  "/public/news_imp_assets/tutorials/demo-image.jpg",
                  "/public/news_imp_assets/tutorials/demo-image.jpg",
                ]}
            ...
            <div className="px-4 py-3 dark:bg-slate-800 bg-blue-200 rounded my-5">
              <Text p className="!text-lg leading-relaxed mb-0">
                ...
                <a
                  href="https://github.com/CaoQuocViet/giveback/discussions"
                  target="_blank"
