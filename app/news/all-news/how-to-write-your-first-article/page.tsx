...
import CodeBlock from "@/components/news/news-components/CodeBlock";
import { Article_Entry_inList } from "@/components/news/constants/codeBlocks";
            ...
            <div className='container px-3 pb-[20px] md:mt-[50px] pt-20 md:pt-0'>
                ...
                <div className="dark:bg-slate-800 bg-blue-200 mt-5 rounded px-3 py-2">
                    ...
                    <List type={ListType.disc} className="mt-5">
                        <li><b>NEWS_CONSTANTS folder : </b> inside this we have our _BLOG_SETUP.tsx file where we set our authors, navbar and other details and we have _ARTICLES_LIST.tsx file where we maintain our article list.</li>
                ...
                <Text p>
                    First create a file inside <b>blog</b> folder in <b>pages</b> (/pages/blog/). You can also create a sub folder inside blog folder. For SEO, the best practice is to name the file and folders in all lower case seperated by hyphen  <b>"-"</b> and end with <b>".tsx"</b>. <br /> example: <b>"your-first-article"</b>. This will create a <b>tsx</b> file.
                </Text>
                <Seperator />
                <Text subtitle className="mt-10">
                ...
                <Text p>
                    Go to <b>/NEWS_CONSTANTS/_ARTICLES_LIST.tsx</b> file. Here we will add details of your article in <b>ARTICLES_LIST</b> array as follows.
                </Text>
                ...
                <List type={ListType.disc} className="mt-5">
                    ...
                    <li>
                        ...
                        <Image className="my-5" src="/public/news_imp_assets/tutorials/feature-article-example.png" alt="feature article example | webexpe.com" caption="feature article exmaple" size={ImageSize.DEFAULT} />
                    </li>
                    <li>
                        <b>preview</b><br />
                        <Text p className="mt-2">
                        ...
                        Check the above image for example of check <b>/NEWS_CONSTANTS/_ARTICLES_LIST.tsx</b> file.
                    </li>
                    <li>
                        <b>seo</b><br />
                        <Text p className="mt-2">
                ...
                <Text p>
                    Now we can go to our created file <b>your-first-article</b> and write our article. To write our article we will use different components as shown in
                    <b><LinkTo href='/news/all-news/blog-with-sidebar-layout' passHref> Blog with sidebar layout</LinkTo></b> or <b><LinkTo href='/news/all-news/blog-with-centered-layout' passHref> Blog with centered layout</LinkTo></b>  example. You can also checkout all the available components to write your article in <b><LinkTo href="/news/all-news/all-components" passHref>All Components Demo</LinkTo></b> page.
                </Text>
