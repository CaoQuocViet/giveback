...
import { HowToUseImageCode, HowToUseList, HowToUseSeperator, HowToUseTextCode, rightSideAdCode } from "@/components/news/constants/codeBlocks";
...
const Article = () => {
    ...
    export default Article;
            ...
            <Text p>
                ...
                <u>blog-with-sidebar-layout</u> file inside <u>pages/tutorial</u> folder.
            </Text>
            <Text subtitle className="mt-10 md:text">
                Features
            </Text>
            ...
            <Text p>
                Check <u>blog-with-sidebar-layout</u> in <u>pages/tutorial</u> file to see all the mentioned components in use.
            </Text>
            <List>
                <li>
            ...
            <Text p>
                <b>note:</b> all these components are used in <u>blog-with-sidebar-layout</u> and <u>blog-with-centerd-layout.tsx</u> in <u>pages/tutorial</u>. You can also check <b><LinkTo href="/news/all-news/all-components" passHref>All Components Demo</LinkTo></b>, list of all components, its types and how to use them.
            </Text>
