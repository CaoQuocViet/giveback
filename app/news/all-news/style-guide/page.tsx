'use client';
import { PageLayout, Text, LinkTo, Slider, Seperator, Image, List } from "@/components/news/news-components"
import { ListType, ImageSize, TextAlign } from "@/components/news/shared/enums"
import { combineClasses } from "@/components/news/utils/utils"
    ...
    return (
        <PageLayout>
            <section className="container md:pt-10 pt-20">
                ...
                <b>Text</b> component is used to add text with some default styling in your article. You can see the <LinkTo href="/news/all-news/all-components/#text" className="underline">demo and guide here</LinkTo>. <br />
                ...
                <Seperator />
                <div className="px-4 py-3 dark:bg-slate-800 bg-blue-200 rounded my-5">
                    These are some the basics you need to know about changing the styling with tailwind css, go to the official docs for more info and if you have any issues or queries please feel free to write us at <u>webexpe13@gmail.com</u> or drop a comment on our github discussions <a href="https://github.com/CaoQuocViet/giveback/discussions" target="_blank" rel="noopener noreferrer"><u>github.com/nmayur/nextjs-simple-blog-template/discussions</u></a>.
                </div>
            </section>
        </PageLayout>
    )
