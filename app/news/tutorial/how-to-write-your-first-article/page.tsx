...
import CodeBlock from "@/components/news/components/CodeBlock";
        ...
        <PageLayout home>
            <div className='container px-3 pb-[20px] md:mt-[50px] pt-20 md:pt-0'>
                ...
                <Text p>
                    ...
                    <b><LinkTo href='/news/tutorial/blog-with-sidebar-layout' passHref> Blog with sidebar layout</LinkTo></b> or <b><LinkTo href='/news/tutorial/blog-with-centered-layout' passHref> Blog with centered layout</LinkTo></b>  example. You can also checkout all the available components to write your article in <b><LinkTo href="/news/tutorial/all-components" passHref>All Components Demo</LinkTo></b> page.
                </Text>
