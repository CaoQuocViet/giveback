'use client';
import { PageLayout, Text, LinkTo, Slider, Seperator, Image, List } from "@/components/news/components"
    ...
    return (
        <PageLayout>
            <section className="container md:pt-10 pt-20">
                ...
                <b>Text</b> component is used to add text with some default styling in your article. You can see the <LinkTo href="/news/tutorial/all-components/#text" className="underline">demo and guide here</LinkTo>. <br />
